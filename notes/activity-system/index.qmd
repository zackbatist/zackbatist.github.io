...
alias: https://wiki.zackbatist.info/index.php/Activity_system
---
...
## Procedures
An abstract listing of actions, that if followed, would result in a desired effect.

- Potential effectiveness of tasks dependent on understandings of:
  - the available materials
  - the possibilities and limitations that the materials afford (knowledge for)
  - the methods that may be implemented to express/attain those possibilities given the materials (knowledge that **\<--\>** knowledge how)
  - by creative agents in decision-making roles
- will to adopt, recognition of value
- comparison of tools, cost/benefit analysis
- scoping, defining boundaries, specifically regarding possibilities and potential
- projection, speculation about potential outcomes
- recognition of people's work, assemblage of symbols or stereotypes associated with roles or activities
- recognizing domains under which work can be assigned, based on recognition of skill sets and designated roles
