...
\Year{\Progress}  &
  ...
  For the Data and Technology Politics in Archaeology Workshop.
  \newline
...
\Year{\Progress}  &
  ...
  \textbf{Bibliometric network analysis of Viking Age research (BibVik).}
  \newline
  ...
  \Website{https://zackbatist.info/BibVik}
\\
\Year{\Progress}  &
...
\begin{EntriesTable}
  \Duration{2025}{\Ongoing}  &
    ...
    An initiative to encourage maintenance of older code and data among the archaeological research community.
...
\begin{EntriesTable}
% \Year{2025 \newline\footnotesize{April}}  &
%   Joe Roe, \Me, XXXX & XXXX.
%   \textbf{CAA Poster XXXX}
%   Poster presented at the 49th Computer Applications and Quantitative Methods in Archaeology Conference (CAA 2021).
%   Vienna, Austria.
