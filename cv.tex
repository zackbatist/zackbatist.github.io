...
\newcommand{\PersonalWebsite}{zackbatist.ca}
...
\begin{EntriesTable}
  \Duration{2019}{2021}  &
  \textbf{SSHRC Doctoral Fellowship}. From pipelines to pragmatic engagement: Archaeological data curation as continuous and collaborative practice.
...
\begin{EntriesTable}
  ...
  \newline
  Faculty of Arts and Science and the Ontario Institute for Studies in Education, University of Toronto
  \\
  \Year{2017}  &
