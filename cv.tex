...
%     \Preprint{10.5281/zenodo.8393043} (draft preprint)
%   \\
%   \Year{\Progress}  &
%     \Me { \&} \JoeRoe.
%     \textbf{Archaeology in the fediverse.}
...
%     \Note{Draft produced from a paper presented at ArcheoFOSS XVII.}
%   \\
%   \Year{\Progress}  &
%     \Me.
%     \textbf{Valuation of formal and informal media in archacological information infrastructures.}
%     \Note{Will be submitted to Open Archaeology.}
%   \\
%   \Year{\Progress}  &
%     \Me.
%     \textbf{Data Management Infrastructures and the Distribution of Agency in Archaeological Projects.}
%     \Note{Will be submitted to Open Information Science.}
%   \\
%   \Year{\Progress}  &
%     \Me.
%     \textbf{Open data, overstated:
%     an exploration of small-scale, offline and private acts of data-sharing within archaeological projects.}
%     \Note{Will be submitted to the Journal of Electronic Publishing Special Issue \emph{On Gathering: Exploring Collective and Embodied Modes of Scholarly Communication.}}
% \end{EntriesTable}
...
\begin{EntriesTable}
  \Year{2023} &
    ...
    \newline
    Panel convened for \href{https://www.archeofoss.org/2023/}{ArcheoFOSS XVII}
    \newline
...
\begin{EntriesTable}
\Duration{2018}{\Ongoing} &
  Scientific Scripting Languages in Archaeology Special Interest Group,
  \newline
