...
\Year{\Review}  &
  \Me.
  \textbf{The value of formal and situated representations in archaeological data work.}
  Open Archaeology.
  \\
\Year{\Review}  &
  \Me { \&} \JoeRoe.
  ...
  \Website{zackbatist.info/openarchaeo-collaboration} (draft pre-print)
  \\
\Year{2023}  &
  \Me { \&} \JoeRoe.
...
\Year{\Progress}  &
  ...
  %\Note{Will be submitted to Computer Supported Cooperative Work}
  \\
\Year{\Progress}  &
  \Me.
  \textbf{Scaffolding archaeological data work}
  %\Note{Will be submitted to the Journal of Archaeological Method and Theory}
  \\
\Year{\Progress}  &
  \Me.
  ...
  %\Note{Will be submitted to the editied volume \emph{Politics of Open Infrastructures: Exploring open digital knowledge infrastructures and socio-political dynamics}}
  \\
\Year{\Progress}  &
  \Me.
  ...
  %\Note{Deriving from a paper presented at ArcheoFOSS XVII}
  \\
\Year{\Progress}  &
  \Me { \&} \JoeRoe.
  \textbf{Archaeology in the fediverse: reclaiming ownership of scholarly social media}
  %\Note{Position paper articulating the discussion held during our panel at ArcheoFOSS XVII}
\end{EntriesTable}
