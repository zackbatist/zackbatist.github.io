---
title: Scholarly metadata pertaining to monographs and grey literature
description: Report on activities relating to the retrieval, extraction and collation of bibliographic metadata pertaining to a corpus of archaeological publications.
date: 2025-08-18
...
Ideally, we would be able to do something like what Alex Brandsen [-@brandsen2023] accomplished: extracting specific kinds of information from archaeological publications using machine learning techniques.
But neither of us really has that kind of practical expertise, at least not yet, anyway.

![Screenshot from @brandsen2023 highlighting named entity recognition detected in archaeological publications.](brandsen.png)

Overall, the situation is kind of challenging, but potentially very rewarding too.
Grappling with these issues makes the difference between a rather uniformly lazy meta-science approach and good social scientific research.
